            ...
            <tr>
              <td>
                ...
                <div style={styles.section}>
                  <div style={styles.oh}>
                    <BadDropdown>
                      <button onClick={() => this.setState(state => ({ toggleContent: !state.toggleContent }))}>
                        Toggle
                      </button>
              ...
              <td>
                ...
                <div style={styles.section}>
                  <div style={styles.oh}>
                    <Dropdown>
                      <button key={Math.random()} onClick={() => this.setState(state => ({ toggleContent: !state.toggleContent }))}>
                        Toggle
                      </button>
                      {this.state.toggleContent ? 'Dropdown content' : ''}
                    </Dropdown>
